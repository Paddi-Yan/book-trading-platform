...
public class FavoriteController {
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "userId", value = "用户编号", required = true), @ApiImplicitParam(name = "bookId", value = "书籍编号", required = true)})
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "userId", value = "用户编号", required = true)})
