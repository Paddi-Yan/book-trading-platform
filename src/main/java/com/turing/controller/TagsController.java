...
public class TagsController {
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "userId", value = "用户编号", required = true), @ApiImplicitParam(name = "tagName", value = "标签分类名称", required = true)})
    ...
    @ApiImplicitParams(value = {@ApiImplicitParam(name = "userId", value = "用户编号", required = true), @ApiImplicitParam(name = "tagId", value = "标签分类编号", required = true)})
