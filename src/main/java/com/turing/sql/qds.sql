...
insert into `comment`(`id`, `post_id`, `user_id`, `content`, `create_time`)
values (2, 2, 1, '哈哈哈哈', '2022-01-27 22:44:09'),
       (3, 3, 1, '寄！', '2022-01-27 22:44:09'),
       (5, 2, 1, '啊宝贵的发不发', '2022-02-06 15:38:41');
...
insert into `community`(`user_id`, `community_id`)
values (1, 1),
       (2, 1),
       (1, 2);
...
insert into `community_infor`(`com_id`, `com_name`, `com_photo`, `com_infor`, `user_id`, `kind`)
values (1, '第一社区', NULL, 'hhhhhhhh', 1, 1),
       (2, '第二社区', NULL, 'hhhhh', 2, 2),
       (3, '第三社区', NULL, 'hhhhhhhhhhhh', 1, 1),
       (4, 'wrew', NULL, 'tqteq', 2, 3);
...
insert into `post`(`post_id`, `community_id`, `user_id`, `book_id`, `title`, `content`, `photo`, `type`, `create_time`)
values (2, 1, 1, NULL, '第一', NULL, NULL, 0, '2022-01-27 22:23:10'),
       (3, 1, 1, 1, '第一', NULL, NULL, 0, '2022-02-07 22:24:26'),
       (4, 1, 1, NULL, 'afdas', 'dgasg', NULL, 0, '2022-02-06 15:31:54'),
       (5, 2, 1, NULL, '三个生日歌', '我哥我哥', '', 0, '2022-02-06 16:29:22');
